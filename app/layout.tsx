        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              ${META_PIXEL_ID ? `fbq('init', '${META_PIXEL_ID}'${META_PIXEL_TEST_CODE ? `, {test_event_code: '${META_PIXEL_TEST_CODE}'}` : ''});
              fbq('track', 'PageView');` : `console.warn('[Meta Pixel] NEXT_PUBLIC_META_PIXEL_ID not configured');`}
            `,
          }}
        />
        {META_PIXEL_ID && (
